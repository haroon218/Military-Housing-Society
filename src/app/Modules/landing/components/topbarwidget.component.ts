...
@Component({
    ...
    template: `<a class="flex items-center" href="#">
             <img src="/assets/images/logo.jpeg" alt="Logo" loading="lazy" style="max-height: 50px;">
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">MACHS</span>
        </a>
